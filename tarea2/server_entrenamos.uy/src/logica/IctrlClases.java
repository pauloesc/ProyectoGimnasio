...
public interface IctrlClases {
	...
	public abstract void crearClase(String nombre, Date Finicio, String prof, int Smin, int Smax, String url, Date FechaAlta, String nomAct, Integer hor, Integer min, String img, String descPremios, int cantPremios) throws ClaseRepetidaException;
	...
	public abstract void registrarSocioAClase(String nick, String actDep, String clas, boolean cuponera, String nomCuponera, Date fechaReg) throws ClaseYaCompradaException, ClaseLlenaException;
