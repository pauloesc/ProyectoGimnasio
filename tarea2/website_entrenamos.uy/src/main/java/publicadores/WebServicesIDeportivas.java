...
public interface WebServicesIDeportivas {
     ...
     */
    @WebMethod
    @Action(input = "http://Publicadores/WebServicesIDeportivas/cargarDatosIDeportivasRequest", output = "http://Publicadores/WebServicesIDeportivas/cargarDatosIDeportivasResponse")
