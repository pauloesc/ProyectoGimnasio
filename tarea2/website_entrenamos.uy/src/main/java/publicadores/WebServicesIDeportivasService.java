 ...
 * 
 */
@WebServiceClient(name = "WebServicesIDeportivasService", targetNamespace = "http://Publicadores/", wsdlLocation = "http://localhost:9128/CtrlInstDeportivas?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9128/CtrlInstDeportivas?wsdl");
