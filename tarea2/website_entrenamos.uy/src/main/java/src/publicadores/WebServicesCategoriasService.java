 ...
 * 
 */
@WebServiceClient(name = "WebServicesCategoriasService", targetNamespace = "http://Publicadores.src/", wsdlLocation = "http://localhost:9129/ctrlCategorias?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESCATEGORIASSERVICE_QNAME = new QName("http://Publicadores.src/", "WebServicesCategoriasService");
    ...
    public WebServicesCategorias getWebServicesCategoriasPort() {
        return super.getPort(new QName("http://Publicadores.src/", "WebServicesCategoriasPort"), WebServicesCategorias.class);
    }
    ...
    public WebServicesCategorias getWebServicesCategoriasPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Publicadores.src/", "WebServicesCategoriasPort"), WebServicesCategorias.class, features);
    }
