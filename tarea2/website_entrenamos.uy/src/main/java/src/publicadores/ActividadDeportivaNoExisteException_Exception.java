 ...
 * 
 */
@WebFault(name = "ActividadDeportivaNoExisteException", targetNamespace = "http://Publicadores.src/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: src.publicadores.ActividadDeportivaNoExisteException
     */
