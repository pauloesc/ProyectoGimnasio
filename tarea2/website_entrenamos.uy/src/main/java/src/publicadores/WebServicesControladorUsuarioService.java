 ...
 * 
 */
@WebServiceClient(name = "WebServicesControladorUsuarioService", targetNamespace = "http://Publicadores.src/", wsdlLocation = "http://localhost:9128/ControladorUsuario?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESCONTROLADORUSUARIOSERVICE_QNAME = new QName("http://Publicadores.src/", "WebServicesControladorUsuarioService");
    ...
    public WebServicesControladorUsuario getWebServicesControladorUsuarioPort() {
        return super.getPort(new QName("http://Publicadores.src/", "WebServicesControladorUsuarioPort"), WebServicesControladorUsuario.class);
    }
    ...
    public WebServicesControladorUsuario getWebServicesControladorUsuarioPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Publicadores.src/", "WebServicesControladorUsuarioPort"), WebServicesControladorUsuario.class, features);
    }
