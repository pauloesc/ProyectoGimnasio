 ...
 * generated in the src.publicadores package. 
...
public class ObjectFactory {
    ...
    private final static QName _InstitucionDeportivaNoExisteException_QNAME = new QName("http://Publicadores.src/", "InstitucionDeportivaNoExisteException");
    private final static QName _InstitucionDeportivaRepetidaException_QNAME = new QName("http://Publicadores.src/", "InstitucionDeportivaRepetidaException");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: src.publicadores
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Publicadores.src/", name = "InstitucionDeportivaNoExisteException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Publicadores.src/", name = "InstitucionDeportivaRepetidaException")
