 ...
 * 
 */
@WebServiceClient(name = "WebServicesADeportivasService", targetNamespace = "http://Publicadores.src/", wsdlLocation = "http://localhost:9128/CtrlActDeportivas?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESADEPORTIVASSERVICE_QNAME = new QName("http://Publicadores.src/", "WebServicesADeportivasService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9128/CtrlActDeportivas?wsdl");
    ...
    public WebServicesADeportivas getWebServicesADeportivasPort() {
        return super.getPort(new QName("http://Publicadores.src/", "WebServicesADeportivasPort"), WebServicesADeportivas.class);
    }
    ...
    public WebServicesADeportivas getWebServicesADeportivasPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Publicadores.src/", "WebServicesADeportivasPort"), WebServicesADeportivas.class, features);
    }
