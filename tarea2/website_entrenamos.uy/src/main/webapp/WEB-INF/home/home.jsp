    	...
    	<div class="row">
      		<div class="col-6 col-md-4">
      			<ul id="listaActividades" class="list-group my-4">
  					...
  					<li class="list-group-item"><a href="consultaInstitucionDeportiva.html" class="">Telon</a></li>
  					<li class="list-group-item"><a href="consultaInstitucionDeportiva.html" class="">Instituto Natural</a></li>
  					<li class="list-group-item"><a href="consultaInstitucionDeportiva.html" class="">Olympic</a></li>
  					<li class="list-group-item"><a href="consultaInstitucionDeportiva.html" class="">Fuerza Bruta</a></li>
				</ul>
      		...
      		<div class="col-12 col-md-8">
      			<div class="row py-4">
					  ...
					  <div class="carousel-inner">
					    ...
					    <div class="carousel-item">
					      <img src="./resources/img/1.jpg" class="d-block w-100" alt="Jiu-Jitsu">
					    </div>
					    <div class="carousel-item">
				...
				<div class="card-group my-4">
				  <div class="card">
				    ...
				    <div class="card-body">
				      <h5 class="card-title"><a href="consultaActividadDeportiva.html" class="">Actividad 1</a></h5>
				  ...
				  <div class="card">
				    ...
				    <div class="card-body">
				      <h5 class="card-title"><a href="consultaActividadDeportiva.html" class="">Actividad 2</a></h5>
				  ...
				  <div class="card">
				    ...
				    <div class="card-body">
				      <h5 class="card-title"><a href="consultaActividadDeportiva.html" class="">Actividad 3</a></h5>
